...
function utt_group_overlaps_scripts(){
    ...
    wp_enqueue_script( 'groupOverlapScripts',  plugins_url('js/groupsoverlappingScripts.js', __FILE__) );
    //localize groupScripts
    wp_localize_script( 'groupsOverlapScripts', 'groupOverlapStrings', array(
